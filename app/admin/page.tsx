...
export default function Admin() {
  ...
  const hasAdminSidebar = panelVisibility.showSyncSettings
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 font-sans text-gray-900 pb-20">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-8">
        ...
        <div className={hasAdminSidebar ? 'grid grid-cols-1 lg:grid-cols-3 gap-8' : 'w-full'}>
          ...
          <div className={hasAdminSidebar ? 'space-y-8 lg:col-span-2' : 'mx-auto w-full max-w-[1400px] space-y-8'}>
